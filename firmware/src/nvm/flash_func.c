...
///
//==============================================================================
void PAC5XXX_RAMFUNC flash_erase_page(uint32_t page_num)
{
...
///
//==============================================================================
void PAC5XXX_RAMFUNC flash_erase_key(uint32_t key)
{
    // Enable Write Access to FLash Controller
    PAC55XX_MEMCTL->FLASHLOCK = FLASH_LOCK_ALLOW_WRITE_ERASE_FLASH;
...
#endif
void PAC5XXX_RAMFUNC flash_write(uint8_t *p_dest, uint8_t *p_src, uint32_t size_bytes)
{
...
///
//=================================================================================================
uint32_t PAC5XXX_RAMFUNC flash_write_16byte_aligned(uint32_t *p_dest, uint32_t *p_src, uint32_t size_32bit_words)
{
...
///
//==============================================================================
void PAC5XXX_RAMFUNC flash_write_word(uint32_t * p_dest, uint32_t value)
{
