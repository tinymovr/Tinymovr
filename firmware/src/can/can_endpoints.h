...
static const uint32_t avlos_proto_hash = 1806246068;
extern uint8_t (*avlos_endpoints[101])(uint8_t * buffer, uint8_t * buffer_len, Avlos_Command cmd);
...
* avlos_nvm_num_slots
*
* Number of wear leveling slots (calculated from config size).
*
* Endpoint ID: 13
*
* @param buffer
...
*
* Current active slot (0 to num_slots-1).
*
* Endpoint ID: 14
*
* @param buffer
...
*
* Total writes since first use (sequence number).
*
* Endpoint ID: 15
*
* @param buffer
...
/*
* avlos_nvm_remaining_writes_estimate
*
