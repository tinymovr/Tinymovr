...
extern uint8_t (*avlos_endpoints[91])(uint8_t * buffer, uint8_t * buffer_len, Avlos_Command cmd);
...
/*
* avlos_sensors_select_position_raw_angle
*
...
/*
* avlos_sensors_select_commutation_raw_angle
*
