...
extern PAC5XXX_RAMFUNC uint32_t ssp_write_one(SSP_TYPE ssp, uint16_t data);
extern PAC5XXX_RAMFUNC uint32_t ssp_write_multi(SSP_TYPE ssp, uint16_t *data, uint32_t byte_num);
